...
image:https://img.shields.io/github/license/vulpine-io/go-midl.svg[MIT License]
image:https://travis-ci.org/vulpine-io/go-midl.svg?branch=master[Build Status,link=https://travis-ci.org/vulpine-io/go-midl]
image:https://img.shields.io/codecov/c/github/vulpine-io/go-midl.svg[Codecov,link=https://codecov.io/gh/vulpine-io/go-midl]
image:https://goreportcard.com/badge/github.com/vulpine-io/go-midl[Go Report Card, link=https://goreportcard.com/report/github.com/vulpine-io/go-midl]
